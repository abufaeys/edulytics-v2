...
- [Link to Project Video](https://streamable.com/z8wbq)
...
The theme for the students is **Gamification**. As a Student we have identified that, what they are most concerned about is where they stand in class, and if they are lagging behind. Our application revolves around the **Elo Rating** and **Attribute System**, an idea inspired by games like DOTA. We want to enable student to track, analyze and be aware of their standings in class. But at the same time, too much competitiveness may result in demoralization of weaker students. We plan to strike this balance between competition and motivation by applying a layer of abstraction through gamification. Our vision is for students to treat this as a lifestyle, and see whatever efforts they have put into the course reflected into rising Elo rating.

### Educators

The theme for Educator is **Superpowers**. As an educator we identified that the biggest challenge is to understand students, as they are unique. Our application allows educators to have a <b>overview</b> of all the students in their course and the ability to drill down on students who have red flags. The educators also have to ability to **monitor class activities** such as assignments and online YouTube tutorials, they will have the ability to see who does and watches them. Through our application, we want to enable educators to know each and everyone of their students, enhancing their ability to teach and guide them.
## Features
### Student

#### 1) Basic Course Statistics
<p align="center"><img src="https://i.imgur.com/z2aOtVG.png" style="width:70%; text-align:center"/></p>
Above is the Basic Course Satistics which comprises of Elo Rating, Total levels completed and Average Playtime per level. **Elo Rating** is our take on gamified ranking system, where by students would not have a definite understanding of how it is calculated, this is to prevent them from abusing the system. In addition, we have chosen to use a rating system as opposed to a hard rank like 1,2,3 as from our findings it is more motivating to see your rating rising rather than having stuck at a particular rank and have no way to find out how you are progressing towards your next rank. As for **Total levels played** and **Average time taken/level**, they are simple statistics that allow them to see their work slowly pay off.


#### 2) Elo Distribuition Chart
<p align="center"><img src="https://i.imgur.com/OPq0yLs.png" style="width:50%" align = "center"/></p>
...
<img src = "https://i.imgur.com/gt5mrji.png" style="width:50%" align = "center"/>
...
<img src="https://i.imgur.com/KsS99yZ.png" width = "100%" align = "center"/>
...
<img src="https://i.imgur.com/FXXnXbm.png" width = "100%" align = "center"/>
...
<img src="https://i.imgur.com/tCaAVHs.png" height =300 align = "center"/>
...
<img src="https://i.imgur.com/8A5NQXa.png" width = "100%" align = "center"/>
