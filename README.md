...
- [Principles](#principles)
    - [Gamification for Students](#gamification-for-students)
    - [Superpowers for Educators](#superpowers-for-educators)
- [Features](#features)
...
The application revolves around 2 main principles: Gamification for Students and Superpowers for Educators

### Gamification for Students

The theme for the students is **Gamification**. We have identified that students are most concerned with where they stand in class, and if they are lagging behind. Our application revolves around the **Elo Rating** and **Attribute System**, an idea inspired by games like DOTA. We believe that students should be able to track, analyse and be aware of their standings in class. Granted, too much competitiveness may demoralise weaker students. We plan to strike this balance between competition and motivation by applying a layer of abstraction through Gamification. Our vision is for students to treat this as a lifestyle, and see the efforts they have put into the course reflected in their gradually rising Elo ratings.

### Superpowers for Educators

The theme for Educators is **Superpowers**. We have identified that the largest challenge for educators, simply put, is to understand students. Edulytics not only allows educators to have an **overview** of all students in their course, but also the ability to drill down on specific students. The educators are also given the ability to **monitor class activities** such as the submission of assignments and online YouTube tutorials; they will be able to see who does and watches them, and at what times. Edulytics aims to provide educators with both the data and tools to personally understand each student, enhancing educator-student relationships.
